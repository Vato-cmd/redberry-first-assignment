...
export default function EnrolledCoursesPanel() {
  ...
  return (
    <section className="w-198.5 h-screen bg-[#F5F5F5] fixed right-0 top-0 overflow-y-auto">
      {error && <p>{error}</p>}
      {isLoading && <p>loading enrolled courses...</p>}

      <div className="flex items-center justify-between px-[57px] pt-[42px]">
      ...
      <div className="ml-[73.5px] mr-[97.5px]">
        {enrolledCourses.map((enrolledCourse) => {
          ...
          return (
            <div
              key={enrolledCourse.key}
              className="bg-[#FFFFFF] rounded-xl p-5 w-[623px] h-[295px] mt-8"
            >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="bg-[#DDDBFA] w-[442px] h-[15.126176834106445px] rounded-[30px] ">
                    <div
