        ...
        <div>
          <div className="flex items-center justify-between mb-8 h-12">
            ...
            <p
              ...
              className="flex items-center text-[#8A8A8A] font-medium text-[16px] gap-1.75 cursor-pointer hover:text-[#4F46E5]"
            >
              Clear All Filters
              <img className="w-2.5 h-2.5" src={cross} alt="cross icon" />
            </p>
          </div>
          <Filters />
        </div>
